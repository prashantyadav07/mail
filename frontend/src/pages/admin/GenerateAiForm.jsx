...
const GenerateAiForm = () => {
  ...
  return (
    <div className="container mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
      <h2 className="text-3xl font-bold mb-6 text-gray-800">Generate Form with AI</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea value={prompt} onChange={(e) => setPrompt(e.target.value)} required rows="4" placeholder="e.g., 'Create a customer feedback survey for a new coffee shop'" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"/>
        </div>
